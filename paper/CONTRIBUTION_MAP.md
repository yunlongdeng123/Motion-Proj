...
### P20/P21/P22 hard-evidence addendum
...
Supplement Figure~1 is rendered by `plot_worldsim_v7_p21_safety_boundary.py` from frozen P20/P21/P22 summaries. Its proxy bars
...
- P20/P21 own the literal source first-return correction and deletion theorem; P22 owns the consumed-AV2 literal correction.
  They do not replace P3/P15 frozen proxy metrics, authorize a failed policy, or establish fresh transfer, hit/Chamfer monotonicity,
...
- Target-nearest proximity and literal first-return are named separately; P20/P22 own literal measurements and P21 owns the theorem.
