...
\begin{itemize}
    \item a hazard-preserving physical compiler with explicit \textsc{keep/project/complete/unknown} semantics, separate appearance/collision state, and a visibility-conditioned ray certificate that retains Actor-level failures;
