...
The exact hazard-stratified decomposition exposes where this utility is obtained. Hazardous Actors are
\PfourteenHazardActorShare{}\% of the cohort. P4 repairs \PfourteenPfourHazardCoverage{}\%/\PfourteenPfourClearCoverage{}\%
of hazardous/clear Actors, whose selected visible risks are \PfourteenPfourHazardRisk{}\%/\PfourteenPfourClearRisk{}\%
versus \PfourteenAlwaysHazardRisk{}\%/\PfourteenAlwaysClearRisk{}\% under always-repair. Thus only
\PfourteenPfourHazardFailureReduction{} of P4's 48 removed failures are hazardous, while
\PfourteenPfourClearFailureReduction{} are clear. Hazardous Actors carry \PfourteenPfourHazardFailureShare{}\% of P4's
introduced failures (\PfourteenPfourHazardBurden{}$\times$ their population share) and contribute
\PfourteenPfourHazardGainShare{}\% of its gain. P6-C repairs \PfourteenPsixHazardCoverage{}\% of hazardous Actors at
\PfourteenPsixHazardRisk{}\% risk; P4-and-visibility reaches zero observed hazardous failure only at
\PfourteenDualHazardCoverage{}\% hazard coverage. State preservation therefore does not imply hazard-stratum risk reduction.
