...
P19 removes \PtwentyPnineteenHazardRemoved{} events for \PtwentyPnineteenHitsLost{} hits and
\PtwentyPnineteenPenaltyMM{}\,mm mean Chamfer. Thus the certified early direction has nonzero surface cost.

On consumed AV2 (\PtwentytwoActors{} Actors; \PtwentytwoRays{} rays), total/hazard exposure similarly changes from
\PtwentytwoProxyTotalEarly{}/\PtwentytwoProxyHazardEarly{}\% to \PtwentytwoTrueTotalEarly{}/\PtwentytwoTrueHazardEarly{}\%
(hazard \PtwentytwoHazardRatio{}$\times$). All \PtwentytwoTrueNewEarly{} literal new-early rays are \textsc{complete}; completion
also supplies \PtwentytwoCompleteNewHitShare{}\% of \PtwentytwoTrueNewHits{} new hits, only \PtwentytwoHitEarlyRatio{} hits/early.
This corrects the proxy efficiency claim; it is not fresh transfer, policy, collision, or road-safety evidence.
