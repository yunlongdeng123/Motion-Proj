...
def validate_config(config: Mapping[str, Any]) -> dict[str, Any]:
    if config.get("schema_version") != "worldsim_v4_sky_masks_v1" or config.get("task_id") != TASK_ID or config.get("status") != "running":
    ...
    if data.get("scenes") != {"scene-0048": 45, "scene-0139": 110, "scene-0994": 752}:
    ...
    return {"scene_count": 3, "expected_masks": 588}
