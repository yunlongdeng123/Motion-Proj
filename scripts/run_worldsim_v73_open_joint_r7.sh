...
exec /root/autodl-tmp/envs/motionproj/bin/python scripts/train_worldsim_v73_global_actors.py \
  ...
  --run-id 20260909T131000Z__open-charts-joint-first-surface-s7304-r7 \
  --mode joint --query-surface open_charts --chart-count 64 --chart-resolution 4 --chart-scale .15 --epochs 30 \
