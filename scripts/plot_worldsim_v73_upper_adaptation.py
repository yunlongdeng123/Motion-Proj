...
box(11.5,3.6,3.9,1.1,'Trainable native DPT\n4 / 11 / 17 + fresh 23','#dcefdc')
box(7.4,1.0,3.3,1.1,'Actor 3D queries\nSelect DPT views here','#dcefdc')
...
ax.text(8,5.85,'Proposed upper-tail adaptation: example boundary, not implemented',ha='center',fontsize=14)
...
ax.text(8,.35,'This diagram describes a separate adaptation factor; it does not change R12 or preselect Q-v2 surface parameterization.',ha='center',fontsize=9)
