...
exec /root/autodl-tmp/envs/motionproj/bin/python scripts/train_worldsim_v73_global_actors.py \
  ...
  --run-id 20260909T123000Z__open-charts-lidar-first-surface-s7304-r6 \
  --mode lidar_only --query-surface open_charts --chart-count 64 --chart-resolution 4 --chart-scale .15 --epochs 30 \
  ...
  --ray-support-kind first_surface --ray-support-weight 1 --ray-lateral-ratio 6.666666666666667 --ray-support-samples 1024 --event-weight 0 \
