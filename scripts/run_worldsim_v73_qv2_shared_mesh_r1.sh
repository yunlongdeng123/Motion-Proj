...
exec /root/autodl-tmp/envs/motionproj/bin/python scripts/train_worldsim_v73_global_actors.py \
  ...
  --run-id 20260908T221500Z__shared-mesh-full-track-beam-s7304-r1 \
  --mode joint --query-surface shared_mesh --mesh-level 3 --epochs 30 \
  --completion-init native_surface --native-data-weight 1 --fit-label-times all_window \
