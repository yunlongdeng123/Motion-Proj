...
"$PY" -m pip install 'numpy<2' gymnasium==1.1.1 roma==1.5.2.1 pytorch-lightning==2.2.1 timm==1.0.15 moviepy==2.2.1 positional-encodings==6.0.1 pyogrio rtree ujson pyquaternion jaxtyping ninja rich
cd "$BASE"
...
git -C HUGSIM_splat sparse-checkout set --cone gsplat
