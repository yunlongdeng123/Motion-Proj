...
exec /root/autodl-tmp/envs/motionproj/bin/python scripts/train_worldsim_v73_global_actors.py \
  ...
  --run-id 20260909T063700Z__open-charts-lidar-ray-support-s7304-r4 \
  ...
  --ray-support-weight 1 --ray-lateral-ratio 6.666666666666667 --ray-support-samples 1024 --event-weight 0 \
