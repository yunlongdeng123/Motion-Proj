"""Train the P233 prefix surface using only marginal-CDF runtime inputs."""
...
class MarginalOnlyPrefixSurface(nn.Module):
...
if __name__ == "__main__":
    base.MonotonePrefixSurface = MarginalOnlyPrefixSurface
    base.main()
