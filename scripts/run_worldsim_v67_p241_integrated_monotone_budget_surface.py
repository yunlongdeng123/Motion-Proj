"""Distill a continuous prefix surface with positive integrated budget derivatives."""
...
def _paired_dataset(path,common,training_budgets,heldout_budgets):
 ...
 if not np.array_equal(scenes,heldout_scenes):raise RuntimeError('P241 training/heldout budget rows misaligned')
