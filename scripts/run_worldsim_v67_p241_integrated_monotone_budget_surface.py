...
def _paired_dataset(path,common,feature_budgets,training_budgets,heldout_budgets):
 ...
 if not np.array_equal(scenes,training_scenes) or not np.array_equal(scenes,heldout_scenes):raise RuntimeError('P241 feature/training/heldout rows misaligned')
