...
- 下一阶段先扩充磁盘并做单张 4090 的 C1-BOOT。只有 Base/action 与 preference-support gate 通过后才需要
  停机配置双卡做短 LoRA capacity test。
...
7. [`docs/archive/2026-07/README.md`](docs/archive/2026-07/README.md)：旧计划、报告和评审协议索引。
