...
| V6.2 | P3 hard projection、P2 72-unit/7.2M query、P4 72-unit frozen IR-WM sidecar formal 均 passed；P5 active | 不得把 O_eval 引入方法或用 all-UNKNOWN 冒充安全；evidence/model 编码显式分开；actor 查询不得因当前 ROI 空而删除；隔离 env 必须把自己的 bin 放入 PATH；不新增哈希/校验和/指纹或重审计框架 | `V62-F01`–`V62-F04`；V6.2 plan、P0/P1/P2/P3/P4 docs |
