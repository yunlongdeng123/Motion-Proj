...
| V7.6 复现与数据适配 | [V76-F01 COLMAP track视图错绑](research_failures/entries/V76-F01.md)、[V76-F02 SAM遮挡身份错绑](research_failures/entries/V76-F02.md)；[官方时间test与初始化审计](v76/P0_REPRODUCTION_AUDIT.md) |
