...
<!-- metadata: {"title": "新来源的真实驾驶基线未达到几何归因条件", "defined_ids": ["V74-H2-F22"], "referenced_ids": [], "versions": ["V74-H2"], "topics": ["simulation", "data_evidence"]} -->
...
- 证据：[报告](../../archive/2026-09/v74-0920/WORLDSIM_SIMULATION_FRESH_BASELINE.md)、[原始记录](../../autoresearch/worldsim_simimpact/milestone9/evidence)。
