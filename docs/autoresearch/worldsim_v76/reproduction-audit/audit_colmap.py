...
def main():
    ...
    result = {"task_id": "VADGS-P0-000-COLMAP-AUDIT", "run": str(run),
        ...
        "failure_ledger_refs": ["V76-F01"], "failure_ledger_delta": "new: COLMAP image ID arithmetic assigns tracks to wrong views"}
