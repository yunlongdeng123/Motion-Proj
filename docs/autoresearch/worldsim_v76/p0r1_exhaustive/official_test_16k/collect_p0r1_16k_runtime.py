"""Read-only runtime snapshot after the explicit 16k evaluation."""
import datetime
import hashlib
import json
...
p = run / 'trained_model/iteration_16000.pth'
...
result = {
    ...
    'task_id': 'VADGS-P0R1-000-TEST-16000',
    'evaluation_exit_code': int((run / 'official_test_16k/exit_code.txt').read_text()),
...
target = run / 'official_test_16k/runtime_snapshot.json'
