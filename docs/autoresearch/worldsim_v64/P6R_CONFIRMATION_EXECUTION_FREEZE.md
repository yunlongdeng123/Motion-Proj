...
4. Generate target evidence once, then apply the frozen MLP and 0.40 policy once. Report all 96 case losses and four strata; do not select another coverage.
