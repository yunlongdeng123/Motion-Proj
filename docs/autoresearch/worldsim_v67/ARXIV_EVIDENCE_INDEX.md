...
| P238 | `run://worldsim_v67/WS-V67-P238-CONTINUOUS-BUDGET-PREFIX-SURFACE-01/20260831T040000Z__continuous-budget-prefix-surface-s0-r1` | heldout MAE/calibration fail；0/3，F182 |
| P239 | `run://worldsim_v67/WS-V67-P239-KNOT-PRESERVING-BUDGET-INTERPOLATION-01/20260831T042000Z__knot-preserving-budget-interpolation-s0-r1` | frozen P233 knot-preserving local interpolation；running |
