...
P238虽保持零结构违例，但P201 heldout surface/final MAE=`.015630/.021162`且calibration increase=`.005166`，0/3
（F182）。P239据NeurIPS 2019 spline的local-knot原则，不再用全局family重拟合：冻结P233七点作为精确knots，在
log-budget区间作piecewise-linear interpolation，以保持双轴单调与局部可微性。
...
- Durkan et al., [Neural Spline Flows](https://proceedings.neurips.cc/paper/2019/hash/7ac71d433f282034e088473244df8c02-Abstract.html), NeurIPS 2019.
