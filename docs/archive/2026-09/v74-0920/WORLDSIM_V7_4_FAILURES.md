> **2026-09-13 版本收尾**：本文件保留 H1 最终裁决及过程。H2 结果与过程教训见 [F08–F11 目录](../../../research_failures/ENTRIES.md)；V7.4 整体收尾见 [最终报告](WORLDSIM_V7_4_CLOSEOUT.md)。H1 NO_SURVIVOR 不改写为 H2 全假说已证伪。
