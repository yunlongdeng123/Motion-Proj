...
[同监督固定表面的覆盖、沿束支持和首返回分类（旧图已归档）](../worldsim_v74_closeout_20260913/LEGACY_MEDIA.md#legacy-010)
...
[固定表面的覆盖、支持与首交点（旧图已归档）](../worldsim_v74_closeout_20260913/LEGACY_MEDIA.md#legacy-002)
