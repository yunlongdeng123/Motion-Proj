...
> **当前计划**：[`OCCGS_RESIM_AUTORESEARCH_PLAN_V7.md`](OCCGS_RESIM_AUTORESEARCH_PLAN_V7_EXECUTED.md)
> （本轮自主执行已收尾；终报 [`OCCGS_FINAL_REPORT.md`](OCCGS_FINAL_REPORT_ORIGINAL.md)）。
> **上一计划**：[`MOTION_RESIM_C1_AUTORESEARCH_PLAN_V6.md`](../v6/MOTION_RESIM_C1_AUTORESEARCH_PLAN_V6.md)（`rejected` / 已关闭，见 `RF-18`）
...
本文只写当前决策、执行边界和稳定里程碑。正式数值以 [`EXPERIMENTS.md`](EXPERIMENTS_V1_V7_SNAPSHOT.md) 与对应
run 为准；为什么不能重复旧尝试见 [`RESEARCH_FAILURES.md`](RESEARCH_FAILURES_RF01_RF18.md)。
...
- **执行授权**：V7 计划状态为 `approved_for_autonomous_execution`。允许一个新 agent 在清空 context 后，
  按 [`OCCGS_RESIM_AUTORESEARCH_PLAN_V7.md`](OCCGS_RESIM_AUTORESEARCH_PLAN_V7_EXECUTED.md) **§A0 自主执行协议**
  连续执行，无需逐 gate 人工确认。
...
[`MOTION_RESIM_C1_AUTORESEARCH_PLAN_V6.md`](../v6/MOTION_RESIM_C1_AUTORESEARCH_PLAN_V6.md) 与
...
V6 曾授权按 [`MOTION_RESIM_C1_AUTORESEARCH_PLAN_V6.md`](../v6/MOTION_RESIM_C1_AUTORESEARCH_PLAN_V6.md)
...
V5 必须逐项遵守 [`RESEARCH_FAILURES.md`](RESEARCH_FAILURES_RF01_RF18.md)：
...
2. [`EXPERIMENTS.md`](EXPERIMENTS_V1_V7_SNAPSHOT.md) 的实验登记；
3. 本文件的当前状态与授权；
4. [`RESEARCH_FAILURES.md`](RESEARCH_FAILURES_RF01_RF18.md) 的跨实验解释与重开条件；
5. 下一份正式计划中尚未执行的设计；
...
完整协议见 [`MOTION_RESIM_C1_AUTORESEARCH_PLAN_V6.md`](../v6/MOTION_RESIM_C1_AUTORESEARCH_PLAN_V6.md)：
...
`C1B-02` 已 `rejected`（H1）；终报见 [`C1_V6_FINAL_REPORT.md`](../v6/C1_V6_FINAL_REPORT.md)。当前唯一合法
