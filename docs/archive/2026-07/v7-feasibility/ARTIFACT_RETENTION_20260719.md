...
`docs/archive/2026-07/ROUTE_PIVOT_FINAL_REPORT.md`、同目录 V5 计划、
`BACKBONE_MIGRATION_AUDIT.md` 和 C0 run 中的 42 GB 继续保留为 2026-07-18 当时事实快照，
不用清理后数值回写。
...
| 路径 | SHA-256 |
|---|---|
| `docs/archive/2026-07/ROUTE_PIVOT_FINAL_REPORT.md` | `f72113d8f75fd4950f0393ccf2ed3d2ba83e8f9a795f340284d5f31805476132` |
| `docs/archive/2026-07/MOTION_ROUTE_PIVOT_AUTORESEARCH_PLAN_V5.md` | `14e92920d617400afbcc23e22fba35610a0591892b57c47d3cedc637fddcd810` |
| `docs/archive/2026-07/BACKBONE_MIGRATION_AUDIT.md` | `743347df7dba017ab613a5b3b1720bfdd284eb293cca855ab9943fabf5c401cd` |
