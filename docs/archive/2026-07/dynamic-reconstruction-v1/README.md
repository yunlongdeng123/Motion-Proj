...
- DGGT `blocked` 于 pointops2 PEP 517 build isolation，未运行 inference；
- M6 只完成持久身份资产审计，没有真实编辑压力测试；
- 候选 A novelty `rejected`；M8/M9 未授权。
...
V1 文档中的相对链接可能指向当时的活动根目录。当前状态、当前资产驻留和下一步只看
[`../../../RESEARCH_STATUS.md`](../../../RESEARCH_STATUS.md) 与 V2 计划。
