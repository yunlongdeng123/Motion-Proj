...
- [`pre-v3.3-cleanup/`](pre-v3.3-cleanup/CLEANUP_MANIFEST.md)：V3.3 启动前旧过程产物清理范围、实际释放空间、保留资产 SHA 与恢复边界；
...
恢复研究时先返回当前 [`../../RESEARCH_STATUS.md`](../../RESEARCH_STATUS.md)，再读取
[`../../RESEARCH_FAILURES.md`](../../RESEARCH_FAILURES.md) 和 [`../../EXPERIMENTS.md`](../../EXPERIMENTS.md)。
归档中的“当前任务”“下一步”和命令只解释当时发生了什么。
