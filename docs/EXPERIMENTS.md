...
|---|---|---|
| WS-V75-OMNI-REVIEW-02 / 20260923-proposal-r1至r7-insertion-review | 24例10秒人工先审：r7按第三轮截图仅替换INSERT-02/04/05的原场景和供体，以道路足迹、碰撞和黄绿双框面积筛选；其余21例保留r6。原始参考有视频，生成与评分留空，0新模型调用，待用户确认 | [r7提案与architecture](autoresearch/worldsim_v75/downstream_bench/review-20260923/insertion-review-r7.md)、[r6历史提案](autoresearch/worldsim_v75/downstream_bench/review-20260923/human-feedback-r6.md)、[r5详细修订](autoresearch/worldsim_v75/downstream_bench/review-20260923/human-feedback-r5.md) |
