...
| 2026-07-13 | `p2-v2-gen04-panel1-s20260713-3cb8445` | completed / awaiting review | `3cb8445` | 冻结 SVD Base、val clip 0、25 inference steps、无 adapter；不写 replay cache | 20260713 | 自动检查通过、`uses_future_gt_track=false`；72 个分层 query，62 条有效轨迹，长度中位数 5，survival 44.44%，correction coverage 6.01% | `/root/autodl-tmp/runs/p2-v2-condition/p2-v2-gen04-panel1-s20260713-3cb8445/{manifest.json,resolved.yaml,cases/cond-00-clip-0000-seed-20260713.json,condition_validity_panel/cond-00-clip-0000-seed-20260713.mp4,reviews.template.jsonl,COMPLETE}` | 证明真实 Base 上的 provider 链路与 panel 可运行；仅一例且 review 尚未填写，P2-V2-GEN-04 与 object replay 仍保持 running/blocked |
