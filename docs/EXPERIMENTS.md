...
| WS-V75-ACTOR-SLOWDOWN-G1-QUALIFY-01；G1-GENERATION-01 / 20260921-r1 | 中距来源未来0.5×减速；前5帧输入严格一致，reference未编辑/减速各1段，后段5/5服从编辑，G1通过 | [轨迹报告](v75/ACTOR_TRAJECTORY_COUNTERFACTUAL.md)、[主图](autoresearch/worldsim_v75/actor_trajectory_counterfactual/main-state-error-figure.png) |
| WS-V75-ACTOR-SLOWDOWN-STATE-QUALIFY-01 / 20260921-r1,r2；STATE-GENERATION-01 / r1 | r1在DVGT前向前缺iopath结束；r2同输入完成1次官方DVGT及三臂资格；新增DVGT/class未编辑与减速4段468帧，13.27m误差导致55.61/32.08px响应误差 | [完整结果](v75/ACTOR_TRAJECTORY_COUNTERFACTUAL.md)、[轻量摘要](autoresearch/worldsim_v75/actor_trajectory_counterfactual/summary.json) |
| WS-V75-ACTOR-SLOWDOWN-CONTROL-QUALIFY-01；CONTROL-G1-01；CONTROL-STATE-01 / 20260921-r1 | 复用独立小误差源与既有未编辑序列；新增reference/DVGT/class减速3段351帧，DVGT误差0.380m且响应未退化 | [正反对照](v75/ACTOR_TRAJECTORY_COUNTERFACTUAL.md)、[响应图](autoresearch/worldsim_v75/actor_trajectory_counterfactual/response-error-contrast.png) |
