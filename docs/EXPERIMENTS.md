...
|---|---|---|
| WS-V75-OMNI-REVIEW-02 / 20260923-proposal-r1、r2-10s、r3-replace-actor02、r4-driverq-review、r5/r6-human-feedback | 24例10秒人工先审：第二轮按截图改黑车目标/时间窗、危险右移方向、骑行者路外落点、5个无关/错框移除目标和静止插入片段；r6另把短暂入画的摩托车换成路口巴士；原始参考有视频与黄/绿框，生成与评分留空，0新模型调用，待用户确认 | [r6提案与architecture](autoresearch/worldsim_v75/downstream_bench/review-20260923/human-feedback-r6.md)、[r5详细修订](autoresearch/worldsim_v75/downstream_bench/review-20260923/human-feedback-r5.md)、[r4历史提案](autoresearch/worldsim_v75/downstream_bench/review-20260923/driverq-review.md) |
