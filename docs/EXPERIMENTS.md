...
|---|---|---|
| WS-V75-OMNI-REVIEW-02 / 20260923-proposal-r1、r2-10s、r3-replace-actor02、r4-driverq-review | 24例10秒人工先审：DriverQ已接入11个预处理train场景，按反馈修订8例，换掉静止自车/难辨目标，巴士改加速，修正ego横移坐标并明示+左/−右；原始参考有视频、生成与评分留空，0新模型调用，待用户确认 | [r4提案与architecture](autoresearch/worldsim_v75/downstream_bench/review-20260923/driverq-review.md)、[r3历史说明](autoresearch/worldsim_v75/downstream_bench/review-20260923/README.md)、[r2候选](autoresearch/worldsim_v75/downstream_bench/review-20260923/candidates-10s.json) |
