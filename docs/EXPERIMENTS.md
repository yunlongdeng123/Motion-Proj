...
|---|---|---|
| WS-V75-OMNI-REVIEW-02 / 20260923-proposal-r1；r2-10s | 人工先审case：首4例6秒提案保留；更新全部24例10秒原始参考，明确相机/对象/四类干预，生成结果与评价留空；0新模型调用、0新AI评分，待用户确认新版 | [待审提案与architecture](autoresearch/worldsim_v75/downstream_bench/review-20260923/README.md)、[10秒候选](autoresearch/worldsim_v75/downstream_bench/review-20260923/candidates-10s.json)、[旧6秒候选](autoresearch/worldsim_v75/downstream_bench/review-20260923/candidates.json) |
