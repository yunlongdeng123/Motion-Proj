...
|---|---|---|
| WS-V75-OMNI-REVIEW-02 / 20260923-proposal-r1 | 用户先审case：4个6秒原始参考，明确相机/目标/反事实，factual与CF及评价留空；0新模型调用、0新AI视频评分。旧版前4例人工意见独立保存；新版未批准 | [待审提案与architecture](autoresearch/worldsim_v75/downstream_bench/review-20260923/README.md)、[候选](autoresearch/worldsim_v75/downstream_bench/review-20260923/candidates.json) |
