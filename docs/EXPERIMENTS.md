...
| 2026-07-13 | `p2-v2-gen04-track8-s20260713-59c3f05-net1` | completed / awaiting track review | `59c3f05` | nuScenes val 固定 clip `0/96/192/288/384/480/576/672`；冻结 SVD Base；25 inference steps；无 adapter；不写 replay cache | 20260713–20260720 | 8/8 自动门禁通过：`uses_future_gt_track=false`、有效轨迹 45–72、长度中位数 3–8 帧、survival 29.17%–84.72%、correction coverage 4.27%–7.36%；`point_track_valid` 评审 0/8 | `/root/autodl-tmp/runs/p2-v2-condition/p2-v2-gen04-track8-s20260713-59c3f05-net1/{resolved.yaml,manifest.json,cases,condition_validity_panel,reviews.template.jsonl,REVIEW_README.md,condition_validity_summary.json,COMPLETE}`；config `db483268`；experiment `9d3f4b36` | 真实 Base 的点轨迹评审包已完整；只评 panel 第二栏，8 个 verdict 填完并以 decisive yes ≥70% 汇总前，GEN-04 与 object replay 均保持 blocked |
