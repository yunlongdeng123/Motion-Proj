...
保留核心代码、配置、报告、架构图、失败索引及关键摘要。逐对象/逐射线大表、渲染场景和可重建编译产物按本轮清理清单移出 Git；先存完整外部归档，再删除分支文件。原始研究 runs 与 P1.5/P1.6 失败资产继续保留。清理已完成，见 [归档清单、体积与恢复命令](archives/worldsim_v74_closeout_20260913/README.md)。推送后按已有授权检查无任务并关机。
