...
- [最终报告与架构图](WORLDSIM_V7_4_RESULTS.md)、[详细失败](WORLDSIM_V7_4_FAILURES.md)、[完整结果表](autoresearch/worldsim_v74/final/REAL_RESULTS.md)
...
V74 最终证据在 autoresearch/worldsim_v74/final，P0证据在 autoresearch/worldsim_v74/p0；V73 原始轻量证据在 autoresearch/worldsim_v73，最终 checkpoint/表面保留。大型可重建缓存已按清单清理，历史文件路径不代表所有大文件仍驻留。
