...
- 当前授权：`WS-V5-M2-GEOMETRY-FIRST-REPAIR-01=running`；逐 actor G0–G3 surface 序列已关闭，r011 已支持 Gaussianization density 机制，当前只开放结果盲冻结的 density representation repair；fresh validation/test quality、router、完整 M3 和 KITTI 调参仍未授权
...
- [`WS_V5_M2_GEOMETRY_FIRST_DEVELOPMENT.md`](WS_V5_M2_GEOMETRY_FIRST_DEVELOPMENT.md)：V5 M2 r001–r011、逐 actor request 修正、G0–G3 失败与 Gaussianization density 机制结论；
